...
static bool areTextureViewsEqual(const cgltf_texture_view& lhs, const cgltf_texture_view& rhs)
{
	...
	if (lhs.has_transform)
	{
		...
		if (memcmp(lt.offset, rt.offset, sizeof(cgltf_real_t) * 2) != 0)
			return false;

		if (lt.rotation != rt.rotation)
			return false;

		if (memcmp(lt.scale, rt.scale, sizeof(cgltf_real_t) * 2) != 0)
			return false;
...
static bool areMaterialComponentsEqual(const cgltf_pbr_metallic_roughness& lhs, const cgltf_pbr_metallic_roughness& rhs)
{
	...
	if (memcmp(lhs.base_color_factor, rhs.base_color_factor, sizeof(cgltf_real_t) * 4) != 0)
		return false;
...
static bool areMaterialComponentsEqual(const cgltf_pbr_specular_glossiness& lhs, const cgltf_pbr_specular_glossiness& rhs)
{
	...
	if (memcmp(lhs.diffuse_factor, rhs.diffuse_factor, sizeof(cgltf_real_t) * 4) != 0)
		return false;

	if (memcmp(lhs.specular_factor, rhs.specular_factor, sizeof(cgltf_real_t) * 3) != 0)
		return false;
...
static bool areMaterialComponentsEqual(const cgltf_specular& lhs, const cgltf_specular& rhs)
{
	...
	if (memcmp(lhs.specular_color_factor, rhs.specular_color_factor, sizeof(cgltf_real_t) * 3) != 0)
		return false;
...
static bool areMaterialComponentsEqual(const cgltf_sheen& lhs, const cgltf_sheen& rhs)
{
	...
	if (memcmp(lhs.sheen_color_factor, rhs.sheen_color_factor, sizeof(cgltf_real_t) * 3) != 0)
		return false;
...
static bool areMaterialComponentsEqual(const cgltf_volume& lhs, const cgltf_volume& rhs)
{
	...
	if (memcmp(lhs.attenuation_color, rhs.attenuation_color, sizeof(cgltf_real_t) * 3) != 0)
		return false;
...
static bool areMaterialsEqual(const cgltf_material& lhs, const cgltf_material& rhs, const Settings& settings)
{
	...
	if (memcmp(lhs.emissive_factor, rhs.emissive_factor, sizeof(cgltf_real_t) * 3) != 0)
		return false;
